...
public:
	...
	CRect m_rEyeRegion;//Eye区域
	CRect m_rNoseRegion;//Nose区域
...
protected:
	...
	afx_msg void OnBtnLightcompensate();
	afx_msg void OnBtnMedianFilter();
	afx_msg void OnBtnSobel();
	afx_msg void OnBtnMorphological();
	afx_msg void OnBtnPreciseface();
	//}}AFX_MSG
	DECLARE_MESSAGE_MAP()
};
